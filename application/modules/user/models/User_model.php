...
class User_model extends CI_Model {
    ...
    function get($params = array())
    {
        $this->db->select('user.user_id, user_name, user_password, user_full_name, user_description,
            user_email, user.input_date, user.last_update, user.role_id, user_role.role_name'); 
        ...
        {
            $this->db->where('user.input_date', $params['date']);
        }
    ...
    {
        $this->db->select('user_role.role_id, role_name, input_date, user_role.last_update'); 
        ...
        {
            $this->db->order_by('user_role.last_update', 'desc');
        }
